        ...
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="mt-6">
                ...
                <div class="max-w-lg mx-auto bg-white p-6 rounded-md shadow-md">
                    <h2 class="text-xl font-medium text-gray-700">Create New City</h2>
                    <form action="{{ route('cities.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mt-4">
                            <label class="block" for="name">City Name</label>
                            <input type="text" placeholder="City Name" name="name" id="name" class="mt-2 p-2 bg-gray-100 rounded-md w-full" required>
                        </div>
                        <div class="mt-4">
                            <label class="block" for="description">Description (Optional)</label>
                            <textarea rows="4" placeholder="City Description" name="description" id="description" class="mt-2 p-2 bg-gray-100 rounded-md w-full"></textarea>
                        </div>
