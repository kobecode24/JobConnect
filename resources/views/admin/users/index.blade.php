                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex h-full">
                                            ...
                                            <!-- Details -->
                                            <a href="#" class="rounded-full p-2 pr-0 mr-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#3367d1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            ...
                                            <!-- Edit -->
                                            {{-- <a href="#" class="rounded-full pt-1">
                                            ...
                                            <!-- Delete -->
                                            <form action="#" method="POST" class="rounded-full" onsubmit="return confirm('Are You sure You want To Delete This User?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit">
