                        ...
                        @foreach ($jobOffers as $jobOffer)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-right text-sm leading-5 font-medium">
                                    <a href="{{ route('hr.job_offers.edit', $jobOffer->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                    <form action="{{ route('hr.job_offers.destroy', $jobOffer->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
